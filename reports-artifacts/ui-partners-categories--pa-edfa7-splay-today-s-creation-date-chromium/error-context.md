...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should display today's creation date
- Location: tests/ui/partners/categories.spec.ts:910:7
...
Call log:
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783621652653")').locator('td').first()
