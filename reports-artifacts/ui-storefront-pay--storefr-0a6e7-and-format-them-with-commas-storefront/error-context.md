...
- Name: ui/storefront/pay.spec.ts >> @storefront @pay >> should only accept numbers in the amount and format them with commas
- Location: tests/ui/storefront/pay.spec.ts:73:7
