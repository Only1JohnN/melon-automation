...
- Name: ui/storefront/pay.spec.ts >> @storefront @pay >> should ask a new phone number for a 4-digit OTP instead of continuing
- Location: tests/ui/storefront/pay.spec.ts:222:7
