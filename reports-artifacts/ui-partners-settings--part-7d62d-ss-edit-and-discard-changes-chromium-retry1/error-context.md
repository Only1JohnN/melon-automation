...
- Name: ui/partners/settings.spec.ts >> @partners @settings @smoke >> Business >> Details >> should cancel business edit and discard changes
- Location: tests/ui/partners/settings.spec.ts:336:11
...
Call log:
  - waiting for locator('tr:has(td:has-text("Email")) td:nth-child(2)')
