...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should display Edit option from action menu
- Location: tests/ui/partners/categories.spec.ts:563:7
...
Call log:
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783621269576")').getByRole('button', { name: /open menu/i })
