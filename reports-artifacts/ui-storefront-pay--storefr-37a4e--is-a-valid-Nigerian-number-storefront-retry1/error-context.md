...
- Name: ui/storefront/pay.spec.ts >> @storefront @pay >> should keep Continue disabled until the phone number is a valid Nigerian number
- Location: tests/ui/storefront/pay.spec.ts:198:7
