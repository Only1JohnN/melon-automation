...
- Name: ui/storefront/pay.spec.ts >> @storefront @pay >> should show a payments-completed card that matches the merchant's successful transactions
- Location: tests/ui/storefront/pay.spec.ts:54:7
