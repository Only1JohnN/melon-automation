...
- Name: ui/partners/settings.spec.ts >> @partners @settings @smoke >> Business >> Branches >> should create an offline branch with trading address
- Location: tests/ui/partners/settings.spec.ts:394:11
