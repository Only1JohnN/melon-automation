...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should search category using partial name
- Location: tests/ui/partners/categories.spec.ts:219:7
...
Locator: locator('table').locator('tr:has-text("AUTO-CAT-1783620437602")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783620437602")')
...
- main:
  ...
  - img
  - textbox "Search by category name": AUTO-CAT
  - table:
    - rowgroup:
