...
Call log:
  - waiting for getByRole('combobox', { name: /Category/i })
    - locator resolved to <button disabled type="button" role="combobox" id=":rr:-form-item" data-state="closed" aria-invalid="false" aria-expanded="false" aria-haspopup="dialog" aria-controls="radix-:rs:" aria-describedby=":rr:-form-item-description" class="inline-flex items-center gap-2 whitespace-nowrap text-sm ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 d…>…</button>
                    ...
                    - generic [ref=e132]:
                      ...
                      - generic [ref=e135]:
                        ...
                        - textbox [active] [ref=e180]:
                          - paragraph [ref=e181]: AUTO-1783621627296-0
                    - generic [ref=e182]:
