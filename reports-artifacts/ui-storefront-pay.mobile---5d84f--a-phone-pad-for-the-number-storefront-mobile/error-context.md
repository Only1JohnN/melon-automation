...
- Name: ui/storefront/pay.mobile.spec.ts >> @storefront @pay @mobile >> should bring up the right keyboards: numbers for the amount, a phone pad for the number
- Location: tests/ui/storefront/pay.mobile.spec.ts:24:7
