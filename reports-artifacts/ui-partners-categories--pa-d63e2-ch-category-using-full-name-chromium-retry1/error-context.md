...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should search category using full name
- Location: tests/ui/partners/categories.spec.ts:199:7
...
Locator: locator('table').locator('tr:has-text("AUTO-CAT-1783620407784")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783620407784")')
...
- main:
  ...
  - img
  - textbox "Search by category name": AUTO-CAT-1783620407784
  - table:
    - rowgroup:
      ...
      - row "AUTO-CAT-1783441136340 Automation description 1783441136340 0 2026-07-07 04:18:59 PM Open menu":
        ...
        - cell "Open menu":
          - button "Open menu":
            - text: Open menu
            - img
      - row "AUTO-CAT-1783441153078 Updated 1783441156469 0 2026-07-07 04:19:15 PM Open menu":
...
```ts
  ...
  149 |       body.message
  150 |     ).toMatch(
  151 |       /already exists|duplicate/i
  152 |     );
  153 | 
