...
export default function ApiRequestRow({ log }: Props) {
    ...
    <div className="border-b border-slate-800">
      ...
      >
        ...
        <div className="flex items-center gap-3 shrink-0">
          <span className={`${statusColor} font-medium`}>{log.status}</span>
      ...
      {open && (
        <div className="space-y-6 bg-slate-950 p-6">
          ...
          <div>
            <h4 className="mb-2 font-semibold">Response Headers</h4>
            <pre className="overflow-auto rounded-xl bg-black p-4 text-sm">
