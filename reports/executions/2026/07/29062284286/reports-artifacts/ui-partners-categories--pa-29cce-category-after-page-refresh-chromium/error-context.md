...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should persist created category after page refresh
- Location: tests/ui/partners/categories.spec.ts:963:7
...
Locator: locator('table').locator('tr:has-text("AUTO-CAT-1783648325139")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783648325139")')
