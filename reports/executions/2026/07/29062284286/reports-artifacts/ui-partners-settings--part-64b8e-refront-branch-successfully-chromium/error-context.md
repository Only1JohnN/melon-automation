...
- Name: ui/partners/settings.spec.ts >> @partners @settings @smoke >> Business >> Branches >> should create an online storefront branch successfully
- Location: tests/ui/partners/settings.spec.ts:372:11
