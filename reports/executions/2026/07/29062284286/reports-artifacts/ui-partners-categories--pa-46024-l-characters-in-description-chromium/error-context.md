...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should allow special characters in description
- Location: tests/ui/partners/categories.spec.ts:369:7
...
Call log:
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783647115918")').locator('td').first()
