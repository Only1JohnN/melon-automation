...
Locator: locator('table').locator('tr:has-text("AUTO-CAT-1783648339178")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783648339178")')
...
- main:
  ...
  - img
  - textbox "Search by category name": AUTO-CAT-1783648339178
  - table:
    - rowgroup:
