                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783419612685
                      - generic [ref=e132]:
    ...
    - listbox "Suggestions" [ref=e283]:
      - group [ref=e285]:
        - option "Add Category" [selected] [ref=e286]:
          - img
          - text: Add Category
        - option "Beverages" [ref=e287]: Beverages
        - option "Fresh Produce" [ref=e289]: Fresh Produce
        - option "Household Essentials" [ref=e291]: Household Essentials
        - option "Personal Care & Beauty" [ref=e293]: Personal Care & Beauty
        - option "Snacks & Confectionery" [ref=e295]: Snacks & Confectionery
```
