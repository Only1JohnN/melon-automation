...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should prevent selling price less than cost price (case 2)
- Location: tests/ui/partners/products/product.spec.ts:74:7
                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783417409673
                      - generic [ref=e132]:
