...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should prevent selling price less than cost price (case 1)
- Location: tests/ui/partners/products/product.spec.ts:45:7
                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783417163692
                      - generic [ref=e132]:
