...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should create a single product without variant successfully (basic)
- Location: tests/ui/partners/products/product.spec.ts:10:7
                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783416834454
                      - generic [ref=e132]:
