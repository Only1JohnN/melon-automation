...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should close product preview modal
- Location: tests/ui/partners/products/product.spec.ts:445:7
                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783419572213
                      - generic [ref=e132]:
