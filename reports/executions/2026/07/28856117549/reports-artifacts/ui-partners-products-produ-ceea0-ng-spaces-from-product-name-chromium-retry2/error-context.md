...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should trim leading and trailing spaces from product name
- Location: tests/ui/partners/products/product.spec.ts:217:7
