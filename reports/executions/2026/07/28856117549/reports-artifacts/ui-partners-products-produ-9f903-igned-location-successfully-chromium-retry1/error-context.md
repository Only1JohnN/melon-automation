...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should remove assigned location successfully
- Location: tests/ui/partners/products/product.spec.ts:391:7
                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783419060720
                      - generic [ref=e132]:
