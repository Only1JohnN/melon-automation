...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should prevent promo price greater than selling price (case 1)
- Location: tests/ui/partners/products/product.spec.ts:59:7
                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783417287080
                      - generic [ref=e132]:
