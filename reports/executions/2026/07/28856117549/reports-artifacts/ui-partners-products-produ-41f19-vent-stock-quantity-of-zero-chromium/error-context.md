...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should prevent stock quantity of zero
- Location: tests/ui/partners/products/product.spec.ts:145:7
                    ...
                    - generic [ref=e127]:
                      - generic [ref=e128]:
                        ...
                        - textbox "Product name*" [ref=e130]:
                          ...
                          - text: QA Single Product 1783417942943
                      - generic [ref=e132]:
