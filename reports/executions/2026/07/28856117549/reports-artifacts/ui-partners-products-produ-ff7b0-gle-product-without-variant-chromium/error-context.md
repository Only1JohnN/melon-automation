...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should require product name when creating a single product without variant
- Location: tests/ui/partners/products/product.spec.ts:180:7
