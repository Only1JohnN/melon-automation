...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should keep quantity at zero when category has no products
- Location: tests/ui/partners/categories.spec.ts:729:7
...
Call log:
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783621400883")').locator('td').first()
