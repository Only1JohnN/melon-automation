...
Locator: locator('table').locator('tr:has-text("AUTO-CAT-1783621922936")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783621922936")')
...
- main:
  ...
  - img
  - textbox "Search by category name": AUTO-CAT-1783621922936
  - table:
    - rowgroup:
