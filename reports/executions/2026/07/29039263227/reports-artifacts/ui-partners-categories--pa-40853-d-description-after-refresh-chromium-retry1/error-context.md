...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should retain updated description after refresh
- Location: tests/ui/partners/categories.spec.ts:1044:7
...
Call log:
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783622072976")').getByRole('button', { name: 'Open menu' })
