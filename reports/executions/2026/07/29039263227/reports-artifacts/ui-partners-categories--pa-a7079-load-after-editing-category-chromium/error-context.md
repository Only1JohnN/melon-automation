...
- Name: ui/partners/categories.spec.ts >> @partners @categories @smoke >> should return updated payload after editing category
- Location: tests/ui/partners/categories.spec.ts:1109:7
...
Call log:
  - waiting for locator('table').locator('tr:has-text("AUTO-CAT-1783621974159")').getByRole('button', { name: 'Open menu' })
