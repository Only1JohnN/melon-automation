...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should prevent low stock threshold greater than stock quantity (case 2)
- Location: tests/ui/partners/products/product.spec.ts:119:7
...
- main:
  ...
  - main:
    ...
    - textbox "Product name*":
      ...
      - text: QA Single Product 1782730527214
    ...
    - textbox "Cost Price":
      ...
      - text: ₦3,940
    - text: Profit
    - textbox "Profit": ₦1,097
    - text: Margin (%)
    - textbox "Margin": "21.78"
    - button "Charge Taxes":
      - text: Charge Taxes
      - img
