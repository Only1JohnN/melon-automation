...
- Name: ui/partners/products/product.spec.ts >> @partners @products @single-product @without-variant >> should validate threshold equal to stock quantity
- Location: tests/ui/partners/products/product.spec.ts:132:7
...
Locator: getByText('Low stock threshold can\'t be equal to stock quantity')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Low stock threshold can\'t be equal to stock quantity')
...
- main:
  ...
  - main:
    ...
    - textbox "Product name*":
      ...
      - text: QA Single Product 1782687828235
    ...
    - textbox "Cost Price":
      ...
      - text: ₦2,413
    - text: Profit
    - textbox "Profit": ₦1,274
    - text: Margin (%)
    - textbox "Margin": "34.55"
    - button "Charge Taxes":
      - text: Charge Taxes
      - img
    ...
    - spinbutton "Low Stock Threshold": "10"
    - text: SKU
    - textbox "SKU" [disabled]:
      - /placeholder: Enter Product SKU
      - text: 52EAMQYEB38Y000
