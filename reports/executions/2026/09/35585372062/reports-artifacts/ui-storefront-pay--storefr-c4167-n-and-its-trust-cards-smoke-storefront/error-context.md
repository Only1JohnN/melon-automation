...
- Name: ui/storefront/pay.spec.ts >> @storefront @pay >> should show the business, its verification and its trust cards @smoke
- Location: tests/ui/storefront/pay.spec.ts:23:7
