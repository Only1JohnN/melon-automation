...
- Name: ui/storefront/pay.mobile.spec.ts >> @storefront @pay @mobile >> should ask a new number for an OTP on a phone
- Location: tests/ui/storefront/pay.mobile.spec.ts:70:7
