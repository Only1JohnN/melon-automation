...
- Name: ui/storefront/pay.mobile.spec.ts >> @storefront @pay @mobile >> should fit the phone screen with the business, trust cards and amount form @smoke
- Location: tests/ui/storefront/pay.mobile.spec.ts:9:7
